...
//                "  write(\"\\\\author{Zhi-Ming Dong}\", \"" + latexFileName + "\", append=TRUE)" + "\n" +
...
//
//        for (int i = 0; i < (experiment.getTaskList().size() - 1); i++) {
//            problemList += "\"" + experiment.getTaskList().get(i).getTag() + "\", ";
//        }
//        problemList += "\"" + experiment.getTaskList().get(experiment.getTaskList().size() - 1).getTag() + "\") ";
//
...
//        // Generate full table
//        problemList = "";
//        for (ExperimentProblem<?> problem : experiment.getTaskList()) {
...
//        for (int i = 1; i < experiment.getAlgorithmList().size(); i++) {
//            latexTabularAlignment += StringUtils.repeat("p{0.15cm }", experiment.getTaskList().size());
//            latexTableFirstLine += " & \\\\multicolumn{" + experiment.getTaskList().size() + "}{c|}{" + experiment.getAlgorithmList().get(i).getAlgorithmTag() + "}";
...
//                "            write(\"  \", \"" + latexFileName + "\", append=TRUE)" + "\n" +
//                "          } " + "\n" +
//                "          if (problem == \"" + experiment.getTaskList().get(experiment.getTaskList().size() - 1).getTag() + "\") {" + "\n" +
