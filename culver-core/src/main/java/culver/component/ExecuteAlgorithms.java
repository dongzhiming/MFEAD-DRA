...
import culver.ExperimentComponent;
 ...
 */
public class ExecuteAlgorithms<S extends DefaultMultiTaskDoubleSolution, Result> implements ExperimentComponent {
  ...
  public void run() {
    ...
    System.setProperty("java.culver.util.concurrent.ForkJoinPool.common.parallelism",
